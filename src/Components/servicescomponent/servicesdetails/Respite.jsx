...
import R1 from "../../../assets/services/r1.jpg"
import R2 from "../../../assets/services/r2.jpg"
import R3 from "../../../assets/services/r3.jpg"
        ...
        <motion.section variants={sectionV} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="w-full bg-white px-4 py-10 md:px-8 lg:px-12 4xl:px-32">
            ...
            <div className="mx-auto max-w-5xl">
                ...
                <p className="mt-3 max-w-4xl text-sm leading-7 text-gray-600 md:text-[15px]">
                    Our Respite Care services provide temporary, high-quality support for individuals with intellectual and developmental disabilities, giving families and caregivers peace of mind and a much-needed break. Whether for a few hours, overnight, or short-term stays, we ensure every individual is safe, supported, and engaged.</p>
            </div>
            ...
            <div className="mx-auto mt-8 max-w-5xl">
                <h3 className="text-xl font-bold text-gray-900">Key Aspects of Respite Care</h3>

                <div className="mt-5 grid gap-6 md:grid-cols-2">
                    <Feature title="Short-Term Support">
                        Flexible care options for daytime, overnight, or extended stays.                    </Feature>
                    <Feature title="Safe & Comfortable Environment">
                        Individuals are cared for in welcoming settings with trained, compassionate staff.                    </Feature>
                    <Feature title="Engaging Activities">
                        Meaningful day participation to keep individuals active, social, and supported while away from their primary caregivers.                    </Feature>
                    <Feature title="Peace of Mind for Families">
                        Caregivers can rest knowing their loved ones are safe, respected, and well cared for.                    </Feature>
                </div>
            </div>
            ...
            <div className="mx-auto mt-8 max-w-5xl">
                <h3 className="text-xl font-bold text-gray-900">
                    A Break for Families, Quality Care for Individuals                </h3>
                <p className="mt-2 text-sm leading-7 text-gray-600 md:text-[15px]">
                    Respite Care is designed to support both individuals and their caregivers. By providing reliable, temporary relief, we help families recharge while ensuring individuals continue to receive compassionate, person-centered care.                </p>
            </div>

            {/* FAQ / Accordion */}
            <div className="mx-auto mt-6 max-w-5xl rounded-2xl border border-gray-200 bg-white shadow-sm">
                <FAQItem
                    q="Who can use respite care services?"
                    a="Nursing assessments are completed at intake and followed by regular 45-day reviews."
                />
                <FAQItem
                    q="How long can respite care last?"
                    a="It can range from a few hours to overnight or longer, depending on family needs."
                />
                <FAQItem
                    q="What types of activities are included?"
                    a="Individuals can participate in daily living routines, social activities, and recreational programs."
                />
                <FAQItem
                    q="Is respite care safe?"
                    a="Yes. Our trained staff provide attentive, compassionate, and safe support in a structured environment."
                />
            </div>
        </motion.section>
    );
