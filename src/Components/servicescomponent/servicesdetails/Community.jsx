        ...
        <motion.section variants={sectionV} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="w-full bg-white px-4 py-10 md:px-8 lg:px-12 4xl:px-32">
            ...
            <div className="mx-auto max-w-5xl">
                ...
                <p className="mt-3 max-w-4xl text-sm leading-7 text-gray-600 md:text-[15px]">
                    Our Community Development Services help individuals with intellectual and developmental disabilities engage fully in their communities. We focus on building confidence, reducing social isolation, and encouraging participation in meaningful activities that foster independence and self-determination.
                </p>
            </div>
            ...
            <div className="mx-auto mt-8 max-w-5xl">
                <h3 className="text-xl font-bold text-gray-900">Key Aspects of Community Development</h3>

                <div className="mt-5 grid gap-6 md:grid-cols-2">
                    <Feature title="Skill Building">
                        Training in communication, interpersonal skills, and daily life management.                    </Feature>
                    <Feature title="Community Engagement">
                        Opportunities to participate in educational, recreational, volunteer, and leadership activities.                    </Feature>
                    <Feature title="Social Interaction">
                        Support to reduce social anxiety and encourage positive, lasting relationships.                    </Feature>
                    <Feature title="Personal Growth">
                        Activities of choice that build self-esteem, promote independence, and inspire leadership.                    </Feature>
                </div>
            </div>
            ...
            <div className="mx-auto mt-8 max-w-5xl">
                ...
                <p className="mt-2 text-sm leading-7 text-gray-600 md:text-[15px]">
                    Through community involvement and skill development, we empower individuals to discover their strengths, make meaningful contributions, and live more independent lives.                </p>
            </div>
            ...
            <div className="mx-auto mt-6 max-w-5xl rounded-2xl border border-gray-200 bg-white shadow-sm">
                <FAQItem
                    ...
                    a="Community outings, recreation, volunteer opportunities, educational programs, and skill-building workshops."
                />
                <FAQItem
                    q="Is this program personalized?"
                    a="Yes. Activities are based on individual interests and personal goals."
                />
                <FAQItem
                    q="How does this service support independence?"
                    a="By fostering social confidence, leadership, and life skills that prepare individuals to thrive in their communities."
                />
                <FAQItem
                    q="Can community development be combined with other services?"
                    a="Absolutely. It complements residential, day, and employment programs to provide a holistic support plan."
                />
            </div>
        </motion.section>
    );
