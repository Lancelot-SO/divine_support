        ...
        <motion.section variants={sectionV} initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.2 }} className="w-full bg-white px-4 py-10 md:px-8 lg:px-12 4xl:px-32">
            ...
            <div className="mx-auto max-w-5xl">
                ...
                <p className="mt-3 max-w-4xl text-sm leading-7 text-gray-600 md:text-[15px]">
                    Reliable and accessible transportation is essential for independence. Our Transportation Services ensure individuals with intellectual and developmental disabilities can attend medical appointments, community activities, and daily errands safely and on time.
                </p>
            </div>
            ...
            <div className="mx-auto mt-8 max-w-5xl">
                <h3 className="text-xl font-bold text-gray-900">Key Aspects of Transportation Support</h3>

                <div className="mt-5 grid gap-6 md:grid-cols-2">
                    <Feature title="Medical Appointments">
                        Safe, dependable rides to doctor visits, psychiatric evaluations, dental, vision, and therapy appointments.                    </Feature>
                    <Feature title="Community Engagement">
                        Transportation to social, recreational, and community events to encourage participation and reduce isolation.                    </Feature>
                    <Feature title="Daily Living Needs">
                        Assistance with trips for shopping, banking, and other essential errands.                    </Feature>
                    <Feature title="Reliable & Safe Service">
                        Trained, caring staff provide on-time, secure transportation with attention to individual needs.
                    </Feature>
                </div>
            </div>
            ...
            <div className="mx-auto mt-8 max-w-5xl">
                <h3 className="text-xl font-bold text-gray-900">
                    Transportation That Builds Independence                </h3>
                <p className="mt-2 text-sm leading-7 text-gray-600 md:text-[15px]">
                    We believe getting around should never be a barrier to independence. Our transportation support empowers individuals to stay active, connected, and engaged in their community.                </p>
            </div>

            {/* FAQ / Accordion */}
            <div className="mx-auto mt-6 max-w-5xl rounded-2xl border border-gray-200 bg-white shadow-sm">
                <FAQItem
                    q="Do you provide transportation to all appointments?"
                    a="Yes, including medical, psychiatric, dental, vision, and nutrition-related appointments."
                />
                <FAQItem
                    q="Is transportation available for community activities?"
                    a="Absolutely. We encourage participation in recreational, educational, and social events."
                />
                <FAQItem
                    q="How do families schedule rides?"
                    a="Transportation is coordinated as part of each individual’s support plan."
                />
                <FAQItem
                    q="Are vehicles accessible?"
                    a="Yes, we provide safe and accessible transportation tailored to individual needs."
                />
            </div>
        </motion.section>
    );
